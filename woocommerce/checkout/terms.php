 ...
 *
 * No-op today (no terms page is configured), same real conditional logic as
 * WooCommerce's default — only the wrapper/checkbox markup is restyled.
 *
 * @package Boxara
 */
...
if ( apply_filters( 'woocommerce_checkout_show_terms', true ) && function_exists( 'wc_terms_and_conditions_checkbox_enabled' ) ) {
	...
	?>
	<div class="shop-checkout-page__terms woocommerce-terms-and-conditions-wrapper">
		<?php
		/**
		...
		<?php if ( wc_terms_and_conditions_checkbox_enabled() ) : ?>
			<p class="shop-checkout-page__terms-row form-row validate-required">
