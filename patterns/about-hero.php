...
<div class="wp-block-cover alignfull about-hero" style="min-height:525px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group about-hero__inner">
			...
			<p class="about-hero__eyebrow has-accent-font-family">Ko smo mi</p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"level":1,"className":"about-hero__title","fontFamily":"display"} -->
			<h1 class="wp-block-heading about-hero__title has-display-font-family">KREATORI <mark style="background-color:rgba(0,0,0,0)" class="has-inline-color has-brand-color">DUBINE</mark> I DETALJA</h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"about-hero__lede"} -->
			<p class="about-hero__lede">Boxara je umetnički kolektiv koji spaja fizički i digitalni svet kroz vrhunske dimenzionalne skulpture od papira. Naša strast je unošenje dubine, teksture i karaktera u vaš životni prostor.</p>
			<!-- /wp:paragraph -->
