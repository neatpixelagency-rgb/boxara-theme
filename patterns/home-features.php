...
<div class="wp-block-group home-features">
	...
	<div class="wp-block-group home-features__heading">
		...
		<h2 class="wp-block-heading home-features__title has-display-font-family js-reveal-words">Dizajn koji ima pravu <mark style="background-color:rgba(0,0,0,0)" class="has-inline-color has-brand-color">dubinu</mark>.</h2>
		<!-- /wp:heading -->
	...
	<div class="home-features__row">
		...
		<div class="home-features__item js-reveal-section" style="--reveal-i:0">
			...
			<?php endif; ?>
			<h3 class="home-features__item-title js-reveal-words">Ručno izrađeno u slojevima</h3>
		...
		<div class="home-features__item js-reveal-section" style="--reveal-i:1">
			...
			<?php endif; ?>
			<h3 class="home-features__item-title js-reveal-words">Napravljeno da traje</h3>
