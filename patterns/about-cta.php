...
<div class="wp-block-group about-cta">
	...
	<span class="about-cta__icon js-reveal-section" style="--reveal-i:0" aria-hidden="true"><?php boxara_icon( 'cta-frame' ); ?></span>
	...
	<div class="wp-block-group about-cta__copy">
		...
		<h2 class="wp-block-heading about-cta__title has-display-font-family js-reveal-words">PRONAĐITE SVOJ RAM</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"className":"about-cta__lede"} -->
		<p class="about-cta__lede js-reveal-section" style="--reveal-i:1">Želite unikatno umetničko delo napravljeno specijalno po vašoj želji? Otvorite naš proces naručivanja ili istražite gotove limitirane kolekcije.</p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons about-cta__buttons js-reveal-section" style="--reveal-i:2">
